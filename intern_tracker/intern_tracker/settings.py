"""
Django settings for intern_tracker project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-k@jc&y)9m!e#gz0waw!2_4v9fbg7_3r@-1)e5*%d1wc1apq6y7'
)
...
ROOT_URLCONF = 'intern_tracker.urls'
...
WSGI_APPLICATION = 'intern_tracker.wsgi.application'
